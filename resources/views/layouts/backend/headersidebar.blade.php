				...
				<nav class="main-menu">
					<ul class="nav metismenu">
						<li class="nav-dropdown active">
							<a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="icon dripicons-meter"></i><span>Dashboard</span></a>
							<ul class="collapse nav-sub" aria-expanded="true">
								<li><a href="{{url('kategori')}}"><span>Kategori</span></a></li>
								<li><a href="{{url('tag')}}"><span>Tag</span></a></li>
								<li><a href="{{url('artikel')}}"><span>Artikel</span></a></li>
							</ul>
						</li>
						<li class="nav-dropdown">
							<a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-article"></i><span>Layouts</span></a>
						...
						<li class="nav-dropdown">
							<a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-browser"></i><span>Pages</span></a>
							<ul class="collapse nav-sub" aria-expanded="false">
						...
						<li class="nav-dropdown">
							...
							<ul class="collapse nav-sub">
								...
								<li class="nav-dropdown">
									<a class="has-arrow" href="javascript:void(0)">Form Layouts</a>
									<ul class="collapse nav-sub">
								...
								<div class="row">
									<div class="col">
										...
										<ul class="list-items">
											...
											<li>
												<a href="javascript:void(0);">Womens Tops</a>
											</li>
											<li>
											...
											<li>
												<a href="javascript:void(0);">Mens Jeans</a>
											</li>
										</ul>
									</div>
									<div class="col">
					...
					<ul class="navbar-nav nav-right">
											...
											<div class="card-container">
												<div class="timeline timeline-border">
													...
													<div class="timeline-list  timeline-border timeline-info">
														<div class="timeline-info">
															<div><a href="#"><strong>RSVP</strong></a> for this years hackathon.</div>
						...
						<li class="nav-item dropdown">
							<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
								<img src="/backend/assets/img/avatars/toto.jpg" class="w-35 rounded-circle" alt="Febrianto">
							</a>
